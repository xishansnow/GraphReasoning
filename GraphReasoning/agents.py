...
class ZephyrLlamaCppChat(LlamaCpp):
...
# from llama_index.embeddings.huggingface import HuggingFaceEmbedding  # Not available in current version
from llama_index.core.node_parser import SentenceSplitter

from llama_index.core import VectorStoreIndex, SimpleDirectoryReader, Settings
from llama_index.core.chat_engine import SimpleChatEngine
# from guidance.models import Chat  # Chat not available in guidance 0.3.0+
